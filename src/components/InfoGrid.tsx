...
export const InfoGrid = () => {
    return (
        <div className="w-full flex flex-col lg:grid lg:grid-flow-row-dense lg:grid-cols-4">
            {/*first row grid*/}
            <div className="relative flex flex-col border justify-center items-center p-12 border-black h-[calc(50vw)] lg:h-[calc(25vw)] hover:bg-lime-100 group">
                <div className="scale-100 group-hover:scale-0 group-hover:opacity-0 duration-500">
                    <h3 className="font-bold text-[10vw] text-center">
                        707
                    </h3>
            ...
            <div className="relative flex flex-col border justify-center items-center p-12 border-black h-[calc(50vw)] lg:h-[calc(25vw)] hover:p-2 duration-500 group">
                <div className="w-full bg-[url(/property01.jpg)] bg-no-repeat bg-center h-[calc(50vw)] lg:h-[calc(25vw)] bg-full" />
            </div>
            <div className="relative flex flex-col border justify-between p-12 border-black h-[calc(50vw)] lg:h-[calc(25vw)] group">
                ...
                <div className="h-[calc(25vw)] my-5 overflow-hidden">
            ...
            <div className="relative flex flex-col justify-center border p-10 hover:p-2 duration-500 border-black h-[calc(50vw)] lg:h-[calc(25vw)] group overflow-hidden">
                <h3 className="uppercase font-bold text-5xl md:text-[5vw] h-full leading-[1.2em] duration-500 group-hover:bg-lime-800 group-hover:p-10 group-hover:text-white">
                    Quality.<br />
                    Trust.<br />
                    Value.
                </h3>
            ...
            <div className="flex flex-col border col-span-2 justify-end p-16 border-black h-[calc(50vw)] lg:h-[calc(25vw)] hover:bg-sky-800 duration-500 hover:text-white">
                <h3 className="uppercase font-bold text-3xl md:text-[10vw] leading-[1.2em]">
                    About
                </h3>
            ...
            <div className="relative flex flex-col border justify-center items-center p-16 border-black h-[calc(50vw)] lg:h-[calc(25vw)] hover:p-2 duration-500 group">
            ...
            <div className="relative flex flex-col border p-12 border-black h-[calc(100vw)] lg:h-[calc(25vw)]  group">
                ...
                <div className="flex flex-col text-xl md:text-2xl group-hover:opacity-100 opacity-0 duration-300 flex-grow py-6">
                    <>
